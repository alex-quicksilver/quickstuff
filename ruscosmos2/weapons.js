...
function createWeapons() {
	...
	var morgen = new Weapon("morgen", "assets/Morgensterncurs1.png", "Мощно, но иногда мимо");
	...
	var dynamite = new Weapon("dynamite", "assets/Dynamitecurs.png", "А чёрт его знает");
